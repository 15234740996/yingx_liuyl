    ...
    <script>
        $(function(){
            ...
            $("#captchaImage").click(function(){
                $("#captchaImage").prop("src","${path}/admin/creatImg?d="+new Date().getTime());
            });
                ...
                if(isOk){
                    $.ajax({
                        ...
                        success:function(data){
                            if(data.status==200){
                                //登陆成功  跳转页面
                                location.href="${path}/main/loginshow.jsp";
                            }else{
                                //登陆失败提示信息
                    ...
                    <div class="form-bottom" style="width: 450px">
                        <form role="form" action="" method="post" class="login-form" id="loginForm">
                            ...
                            <div class="form-group">
                                ...
                                <img id="captchaImage" style="height: 48px" class="captchaImage" src="${path}/admin/creatImg">
                                <input minlength="4" type="text" name="enCode" style="width: 289px;height: 50px;border:3px solid #ddd;border-radius: 4px;" required >
                            </div>
